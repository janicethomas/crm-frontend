...
function TicketFormClient(props) {
...
const arr = [subject, status, message];
...
useEffect(()=>{
    ...
    // setAdminReply();
},[props.subjectValue,props.statusValue,props.messageValue])
...
const handleClick = () => {
    ...
    return(
        <div style={{maxWidth:"40%", margin:"0px auto"}}>
            ...
            <br></br> Admin Reply: {props.adminReplyValue} <br></br>
