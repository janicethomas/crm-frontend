...
function AddTicketFormClient()
{
    ...
    return(
        <form onSubmit={handleSubmit}>
            <TicketFormClient getState={getState} subjectValue="" statusValue="" messageValue="" adminReplyValue="">
                Create ticket
            </TicketFormClient>
        </form>
    )
...
export default AddTicketFormClient;
